...
<body>
  ...
  <div class="center">
    ...
    <form action="{{route('admin.login.post')}}" method="post">
      ...
      @endif
      <input class="email" type="email" value="{{old('email')}}" placeholder="Емейл" name="email" required>
      <p class="text"></p>
      <input class="password" type="password" name="password" value="{{old('password')}}" placeholder="Пароль" required>
