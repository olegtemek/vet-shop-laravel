    ...
    <div class="cart-body">
      <div class="row">
        <div class="col-sm-12 row mb-4">
          <h2 class="col-sm-12">Добавить продукт</h2>
          <div class="col-sm-4">
            ...
            <div class="form-group">
              ...
              <select class="form-control" id="filter_select" multiple data-live-search="true">
                @foreach ($filters as $filter)
                    <option class="options" value="{{$filter->id}}">{{$filter->parent->title}} || {{$filter->title}}</option>
                @endforeach
              </select>
            </div>
          </div>
          ...
          <div class="col-sm-12">
            <div class="form-group">
              ...
              <span class="error text-danger">{{ $message }}</span>
              @enderror
              <textarea class="form-control" placeholder="Описание" name="description">{{old('description')}}</textarea>
            </div>
          </div>
